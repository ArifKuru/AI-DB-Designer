...
<head>
    ...
    <title>Login | AI DB Architect</title>
...
<script>
    ...
    loginForm.addEventListener('submit', function (e) {
        ...
        loginBtn.innerHTML = `<i data-lucide="loader-2" class="w-5 h-5 animate-spin mr-2"></i> Checking...`;
        lucide.createIcons();
        alertBox.classList.add('hidden');

        // API Request
        fetch('/auth/api/login.php', {
            method: 'POST',
            body: formData
        })
            ...
            .then(data => {
                if (data.success) {
                    // Success State
                    loginBtn.innerHTML = `<i data-lucide="check" class="w-5 h-5 mr-2"></i> Success! Redirecting...`;
                    lucide.createIcons();
